...
const findExpensiveFlowers = () => {
    ...
    const expensivePrice = 1;

    for (const flower of flowers) {
        if (flower.price >= expensivePrice) {
            console.log(`The ${flower.color} ${flower.species} is Expensive.`);
           
            const expensiveFlower = {}
            expensiveFlowers.push(expensiveFlower);
        }
    }
}
